...
export const metadata = createMetadata({
	title: "NFT Checkout | egiftcard Engine",
	description: "This guide uses egiftcard Engine to sell NFTs with credit card",
});

# NFT Checkout

This guide uses egiftcard Engine to sell NFTs with credit card:
...
- A egiftcard client ID and secret key from the [API Keys page](https://egiftcard.cc/dashboard/settings/api-keys)
- An Engine instance
...
function Home() {
	return (
		<EgiftcardProvider activeChain="<chain_id>" clientId="<egiftcard_client_id>">
			<PurchasePage />
		</EgiftcardProvider>
	);
}
			...
			"<backend_wallet_address>",
			{
				...
				metadataWithSupply: {
					metadata: {
						...
						description: "Created with egiftcard Engine",
						image:
...
The code above is simplified for readability. [View the full source code &rarr;](https://github.com/egiftcard-example/engine-nft-checkout)
...
### How is egiftcard NFT Checkout different?

[egiftcard Checkout](https://egiftcard.cc/checkout) is a full solution that detects fraud, provides chargeback liability, accepts multiple payment methods including cryptocurrency, includes a prebuilt checkout UX, and more.
