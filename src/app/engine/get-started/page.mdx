...
export const metadata = createMetadata({
	title: "Getting started with Engine | egiftcard Infrastructure",
	description:
...
Navigate to the [egiftcard Engine dashboard](https://egiftcard.cc/dashboard/engine) to manage your Engine instances.
...
This code example deploys a [egiftcard NFT drop contract](https://egiftcard.cc/egiftcard.eth/DropERC721). It requires gas funds and returns a `queueId` to query for the result.
