...
### How are Engine and the egiftcard Contract SDK different?

Engine is a server that manages your backend wallets and how they interact with contracts. This difference unlocks capabilities that egiftcard and other web3 SDKs, including:
...
Additionally, Engine is built on top of the egiftcard SDK and has the same capabilities.

### Does Engine work with all egiftcard smart contracts?

Yes. Engine has intuitive interfaces to deploy prebuilt contracts, manage smart accounts, run a marketplace, and more.

### Does Engine work with my non-egiftcard smart contract?

Yes. Engine can read and write to any EVM contract with low-level API calls, including providing raw calldata. ERC-721 and ERC-1155 APIs can also be used for [contracts imported to egiftcard](https://support.egiftcard.cc/smart-contracts/rtHYyzspnPaHmmANmJQz1k/importing-non-egiftcard-contracts-into-the-dashboard/hELLjgTc8TWrMdMEQkm2Es).
...
Use [Update Chain Configuration](https://redocly.github.io/redoc/?url=https://demo.web3api.egiftcard.cc/json#tag/Configuration/operation/updateChainsConfiguration) to override a chain's settings.
