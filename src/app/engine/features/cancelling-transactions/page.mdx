...
export const metadata = createMetadata({
	title: "Cancelling Transactions | egiftcard Engine",
...
_Note: Use [Retry Transaction](https://redocly.github.io/redoc/?url=https://demo.web3api.egiftcard.cc/json#tag/Transaction/operation/retry) instead to increase the gas settings for a queued transaction._
...
Reference: [`Cancel Transaction`](https://redocly.github.io/redoc/?url=https://demo.web3api.egiftcard.cc/json#tag/Transaction/operation/cancel)
