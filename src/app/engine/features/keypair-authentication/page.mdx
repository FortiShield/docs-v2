...
export const metadata = createMetadata({
	title: "Keypair Authentication | egiftcard Engine",
...
[Contact us](https://egiftcard.cc/contact-us) to enable this on your Cloud-hosted Engine instance.
...
1. Navigate to the [Engine dashboard](https://egiftcard.cc/dashboard/engine).
