...
export const metadata = createMetadata({
	title: "Backend Wallets | egiftcard Engine",
	description:
...
Call `POST /backend-wallet/create` or create a wallet from the [Engine dashboard page](https://egiftcard.cc/dashboard/engine).

## Import a wallet

> For AWS or Google Cloud KMS wallets, you must provide your credentials.

Call `POST /backend-wallet/import` or import a wallet from the [Engine dashboard page](https://egiftcard.cc/dashboard/engine).

## List wallets

Backend wallets are listed in the **Backend Wallets** table on the [Engine dashboard page](https://egiftcard.cc/dashboard/engine).
