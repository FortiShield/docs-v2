...
export const metadata = createMetadata({
	title: "ERC-20 Pricing | egiftcard NFT Checkout",
	description:
		"egiftcard supports selling NFTs that accept the USDC token for enterprise customers",
});

# ERC-20 Pricing

> egiftcard supports selling NFTs that accept the USDC token **for enterprise customers only**.
>
> 👉 Read our guide on [How to Price your NFTs in USDC](https://blog.withpaper.com/how-to-price-your-nfts-in-usdc/).

## Integration

### For egiftcard contracts

1. Navigate to the egiftcard dashboard for your contract
...
Make sure your contract requests the correct USDC token address from egiftcard. These are the supported USDC token addresses.
...
egiftcard supports popular ERC-20 (or ERC20) tokens like USDC and WETH. If your NFT is priced in a different token, [contact us](mailto:support@withpaper.com).
