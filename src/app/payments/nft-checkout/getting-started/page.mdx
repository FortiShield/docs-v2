...
export const metadata = createMetadata({
	title: "Getting Started with NFT Checkout | egiftcard Payments",
	description:
...
You can create or deploy a smart contract on egiftcard using [Deploy](https://egiftcard.cc/dashboard/contracts/deploy).
