...
export const metadata = createMetadata({
	title: "Go Live Checklist | egiftcard Payments",
	description:
...
To request a higher price limit, please contact support@egiftcard.cc.

</Step>

<Step title="Inform us of high volume launches">

If you are expecting very high sales volume, please [contact us](https://egiftcard.cc/contact-us) in advance so we can make sure the engineering team is aware and ready to support your launch.
