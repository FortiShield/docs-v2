...
export const metadata = createMetadata({
	title: "One-Time Checkout Link | egiftcard NFT Checkout",
	description:
...
[See the API Reference for creating a one-time checkout link](https://redocly.github.io/redoc/?url=https://payments.egiftcard.cc/api/doc#tag/One-time-Checkout-Links/paths/~1api~12022-08-12~1checkout-link-intent/post)
