...
export const metadata = createMetadata({
	title: "FAQ | egiftcard Payments",
	description: "Frequently asked questions about egiftcard Payments.",
});

# General

### How much does egiftcard Checkouts cost?
...
### How scalable is egiftcard Checkouts? How much load can it handle?
...
See the [overview](/payments) page for a list of supported chains and currencies. We can support any EVM chain upon request. Please contact support@egiftcard.cc if the chain or currency you want to sell in is not on our list.
...
Yes! You'll need to "wrap" your NFT with a marketplace contract like [egiftcard marketplace](/contracts/explore/pre-built-contracts/marketplace) or build your own. This "direct listing" approach works like this:
...
- After the buyer's payment is successful, egiftcard calls the "buy" method with the expected amount in crypto to the marketplace contract. This method transfers the NFT to the buyer's wallet.

## Payments

### Where does egiftcard send the funds after a customer has paid?

egiftcard directly calls the smart contract and pays for the mint using the native currency specified in the contract function. If you are looking for FIAT payout, it is available for the enterprise customers. Please [contact sales](mailto:sales@egiftcard.cc) .

### What regions does egiftcard support credit card payments?
...
egiftcard accepts: credit/debit cards (Visa, Mastercard, American Express, Discover, UnionPay, JCB, Diners Club), Apple Pay, Google Pay.

### What is the price limit for checkouts?

egiftcard limits checkouts to be priced at $2,000 USD and reserves the right to change this limit based on your checkout's risk profile. For enterprise customers, we can support up to $15,000.

If you need a higher price limit, please fill out [this form](https://egiftcard.cc/contact-us).

### When does egiftcard require identity verification (KYC)?

egiftcard combines buyer, merchant, payment method, device, and behavioral signals from multiple vendors to compute the riskiness of a purchase. A small portion of buyers (\< 3% and varies by merchant) will be prompted to submit a photo ID and take a webcam selfie. This step is automated and takes under 1 minute.

Reminder: egiftcard takes on **all** chargeback liability from the developer!
...
Buyers who don't have a wallet can create one with their email or social login. This uses egiftcard's non-custodial [In-App Wallet](/connect/embedded-wallet/overview) product.

### How does my user transfer the NFT from the In-App Wallet?

Buyers can visit [My Wallets](https://ews.egiftcard.cc/wallet) to view and transfer NFTs in their In-App Wallets. We cover all gas fees related to transferring and offer a way for users to export their private key.

## Other

### Does Checkouts support credit card payments for functions outside of minting like burning and editing NFTs?

This feature is available upon request. Please contact us at [sales@egiftcard.cc](mailto:sales@egiftcard.cc).

### What is the customer support level provided to customers?

For developers, please [visit our support site](https://egiftcard.cc/support). If you are looking for guaranteed support time and SLA, please contact [sales@egiftcard.cc](mailto:sales@egiftcard.cc).

For customers, we respond to inquiries on our support center and to [support@egiftcard.cc](mailto:support@egiftcard.cc) within 24 business hours.

### How does egiftcard handle compliance?
...
egiftcard is currently in the process of receiving our SOC II certification.
