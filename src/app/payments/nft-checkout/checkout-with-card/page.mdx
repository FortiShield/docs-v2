...
export const metadata = createMetadata({
	title: "CheckoutWithCard | egiftcard Embedded Elements",
	description:
...
```typescript
import { CheckoutWithCard } from "@egiftcard/react";
...
| ----------------------- | --------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| clientId **\***         | string                                                                                                                            | egiftcard client ID (Obtained from an API key which you can generate on the [Dashboard](https://egiftcard.cc/dashboard))                                                                                                          |
...
<Steps>
  ...
  Follow our SDK [install guide](/react/latest/getting-started) here.
   {/* <!-- prettier-ignore --> */}
		```bash
    npm install @egiftcard/payments
    ```
    {/* <!-- prettier-ignore --> */}
		```bash
    yarn add @egiftcard/payments
    ```
	</Step>
...
```typescript
import { createCheckoutWithCardElement } from "@egiftcard/payments";
