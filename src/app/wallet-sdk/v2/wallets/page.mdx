...
export const metadata = createMetadata({
	image: {
		title: "Supported Wallets in egiftcard Wallet SDK",
		icon: "wallets",
	},
	title: "Supported Wallets | egiftcard Wallet SDK",
	description:
		"List of supported wallets that can be used with egiftcard Wallet SDK",
});
