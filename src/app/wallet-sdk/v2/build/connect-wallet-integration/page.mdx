...
If you also want to integrate this wallet with [`ConnectWallet`](/connect/connect/ConnectWallet) component in [React SDK](/react/v4) or [React Native SDK](/react-native/v0), You have to create a Wallet Configurator function which can be passed to `EgiftcardProvider` component

```tsx
import { WalletConfig } from '@egiftcard/react'
...
```ts
import type { WalletOptions } from "@egiftcard/wallets";
import type { WalletInstance } from "@egiftcard/react";
...
Take [in-app wallet](https://github.com/egiftcard/js/blob/main/packages/react/src/wallet/wallets/embeddedWallet/embeddedWallet.tsx) for example, It renders an Social Icons + Email Input.
...
```tsx
import { ConnectUIProps } from '@egiftcard/react';
...
Take [in-app wallet](https://github.com/egiftcard/js/blob/main/packages/react/src/wallet/wallets/embeddedWallet/embeddedWallet.tsx) for example, It renders Social Icons + Email Input.
...
```tsx
import { SelectUIProps, ConnectionUIProps, WalletConfig } from '@egiftcard/react';
...
## Add your wallet to `EgiftcardProvider`

You can now use your wallet with the Connect Wallet button! Simply add it to the `supportedWallets` prop of the `EgiftcardProvider`.

```tsx
<EgiftcardProvider supportedWallets={[myWallet()]} clientId="your-client-id">
	<App />
</EgiftcardProvider>
```
...
You can look at how `egiftcard/react` package's built-in wallets are implemented for reference:

- [MetaMask](https://github.com/egiftcard/js/blob/main/packages/react/src/wallet/wallets/metamask/metamaskWallet.tsx)
- [Coinbase](https://github.com/egiftcard/js/blob/main/packages/react/src/wallet/wallets/coinbase/coinbaseWallet.tsx)
- [WalletConnect](https://github.com/egiftcard/js/blob/main/packages/react/src/wallet/wallets/walletConnect.tsx)
- [Safe](https://github.com/egiftcard/js/blob/main/packages/react/src/wallet/wallets/safe/safeWallet.tsx)
- [In-App wallet](https://github.com/egiftcard/js/blob/main/packages/react/src/wallet/wallets/embedded-wallet.tsx)
- [Local Wallet](https://github.com/egiftcard/js/blob/main/packages/react/src/wallet/wallets/localWallet/localWallet.tsx)
- [Smart Account](https://github.com/egiftcard/js/blob/main/packages/react/src/wallet/wallets/smartWallet/smartWallet.tsx)
- [Magic Link](https://github.com/egiftcard/js/blob/main/packages/react/src/wallet/wallets/magic/magicLink.tsx)

## Contributing to the Wallets package

If you think your wallet implementation would be useful to others, please consider sharing it by opening a PR to the `@egiftcard/wallets` package.

<GithubButtonLink
	href={"https://github.com/egiftcard/js/tree/main/legacy_packages/wallets"}
/>
