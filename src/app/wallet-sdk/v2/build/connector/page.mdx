...
export const metadata = createMetadata({
	...
	title: "Build a Wallet interface | egiftcard Wallet SDK",
	description: "Learn how to build a Wallet interface for egiftcard Wallet SDK",
});
...
```javascript
import { Connector, ConnectParams } from '@egiftcard/wallets';
...
that resolves to the [`Connector`](https://github.com/egiftcard/js/blob/main/packages/wallets/src/evm/interfaces/connector.ts#L6)
...
You can look at how the built-in wallets in `@egiftcard/wallets` package are created for reference

- [MetaMask](https://github.com/egiftcard/js/blob/main/packages/wallets/src/evm/wallets/metamask.ts)
- [Coinbase](https://github.com/egiftcard/js/blob/main/packages/wallets/src/evm/wallets/coinbase-wallet.ts)
- [WalletConnect v2](https://github.com/egiftcard/js/blob/main/packages/wallets/src/evm/wallets/wallet-connect.ts)
- [Local Wallet](https://github.com/egiftcard/js/blob/main/packages/wallets/src/evm/wallets/local-wallet.ts)
- [Safe](https://github.com/egiftcard/js/blob/main/packages/wallets/src/evm/wallets/safe.ts)
- [Smart Account](https://github.com/egiftcard/js/blob/main/packages/wallets/src/evm/wallets/smart-wallet.ts)
- [In-App Wallet](https://github.com/egiftcard/js/blob/main/packages/wallets/src/evm/wallets/embedded-wallet.ts)
- [Magic Link](https://github.com/egiftcard/js/blob/main/packages/wallets/src/evm/wallets/magic.ts)
