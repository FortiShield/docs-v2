...
can be used during the call execution via `EntryPoint`. The egiftcard [Account ABstraction](/connect/account-abstraction) paymaster is initially paid for by egiftcard. By using an API key,
