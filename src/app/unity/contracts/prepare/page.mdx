...
export const metadata = createMetadata({
	title: "Transaction Builder | egiftcard Unity SDK",
	description:
...
Signs the transaction asynchronously, if the wallet supports it. Useful for smart wallet user op delayed broadcasting through egiftcard Engine. Otherwise not recommended.
