...
export const metadata = createMetadata({
	title: "Call write functions in Smart Contract | egiftcard Unity SDK",
	description:
		"Call write functions in your smart contract using egiftcard's Unity SDK.",
});

# Call Functions

If the functionality of your smart contract does not come under one of egiftcard's supported interfaces, use the generic `Write` method to call any function on the smart contract.
