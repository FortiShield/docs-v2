...
export const metadata = createMetadata({
	title: "WalletConnect | egiftcard Unity SDK",
	description: "Connect to WalletConnect with egiftcard Unity SDK",
});
...
You may set the your WalletConnect Project ID (all platforms) and explorer recommended wallet ids (WebGL only) in the [EgiftcardManager](/unity/egiftcardmanager) prefab.
