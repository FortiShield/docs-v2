...
export const metadata = createMetadata({
	title: "Submit Your Wallet | egiftcard Unity SDK",
	description: "Learn how to add your own wallet to the egiftcard Unity SDK",
});

# Submit Your Wallet

The Egiftcard Unity SDK comes with many built-in wallets, but you can add your own wallet to the SDK by following these steps.
...
## Step 2 - Implement IEgiftcardWallet

Implement the IEgiftcardWallet interface for your wallet. This interface defines the methods and properties required for wallet integration.
...
namespace Egiftcard.Wallets
{
    /// <summary>
    /// Interface for interacting with a Egiftcard wallet.
    /// </summary>
    public interface IEgiftcardWallet
    {
        /// <summary>
...
## Step 3 - Instantiate Your Wallet in EgiftcardSession.Connect

In the EgiftcardSession.cs file, instantiate your wallet in the Connect method.
...
namespace Egiftcard.AccountAbstraction
{
...
If you think your wallet implementation would be useful to others, please consider sharing it by opening a PR to the `egiftcard/unity-sdk` repository.

<OpenSourceCard
	title="Unity SDK"
	href="https://github.com/egiftcard/unity-sdk"
	isLibrary={false}
/>
