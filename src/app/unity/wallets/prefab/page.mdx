...
export const metadata = createMetadata({
	title: "ConnectWallet Prefab | egiftcard Unity SDK",
	description:
...
It uses the [EgiftcardManager](/unity/egiftcardmanager) to determine which networks to display as well as the secondary UI related to certain providers such as WalletConnect.
...
switch networks if multiple networks are set up through the EgiftcardManager.

The prefab is located at: `Assets/Egiftcard/Examples/Prefabs/Prefab_ConnectWallet.prefab`.
