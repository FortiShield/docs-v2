...
Navigate to **[Settings > API Keys](https://egiftcard.cc/dashboard/settings/api-keys)** on the dashboard.
...
By default, Account abstraction services services are enabled upon creation of the API Key. To set additional rules on which transactions you want to sponsor, head to the configuration tab in your [account abstraction dashboard](https://egiftcard.cc/dashboard/connect/account-abstraction)

#### In-App Wallets

By default, In-App Wallet services are enabled upon creation of the API Key. You can view your in-app wallet's settings in the configuration tab of the [in-app wallet dashboard](https://egiftcard.cc/dashboard/connect/in-app-wallets)
