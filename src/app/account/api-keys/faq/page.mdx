...
export const metadata = createMetadata({
	title: "egiftcard API Key FAQs",
	description: "Frequently asked questions about egiftcard API keys",
	image: {
		title: "egiftcard API Key FAQs",
		icon: "egiftcard",
	},
...
### Can I use egiftcard SDKs without an API key?

Yes, you can use egiftcard SDKs without an API key to override the default infrastructure. You will need to provide and pass in your own services to the SDKs.
...
- **Mobile (React Native)**
  ...
  - Programmatically retrieve `bundleId` for iOS or Android
    ...
    - Use the `expo-application` package from the `@egiftcard/react-native sdk`
