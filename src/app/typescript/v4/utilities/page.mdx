...
export const metadata = createMetadata({
	...
	title: "Contract utilities | egiftcard TypeScript SDK",
	description:
		"Verify contracts, get ABI, get functions and events definitions, get sources, resolve proxy implementations, and more with the egiftcard TypeScript SDK.",
});
