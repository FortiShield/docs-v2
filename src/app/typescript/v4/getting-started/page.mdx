...
You can create [Node.js](https://github.com/egiftcard-example/node-typescript-starter),
[Express](https://github.com/egiftcard-example/express-typescript-starter) and other types of projects using the CLI.
...
<div className="flex gap-3">
	Examples templates:
	[Node.js](https://github.com/egiftcard-example/node-typescript-starter) •
	[Express](https://github.com/egiftcard-example/express-typescript-starter)
</div>
