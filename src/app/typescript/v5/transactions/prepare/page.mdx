...
```ts
import { prepareContractCall, toWei } from "egiftcard";
...
```ts
import { prepareTransaction, toWei } from "egiftcard";
...
```shell
npx egiftcard generate <contractId>/<contractAddress>
```
...
```ts
import { getContract, prepareContractCall, toWei } from "egiftcard";
...
```ts
import { prepareContractCall, resolveMethod, toWei } from "egiftcard";
const tx = prepareContractCall({
	contract,
