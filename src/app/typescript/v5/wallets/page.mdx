...
export const metadata = createMetadata({
	...
	title: "Accounts & Wallets | egiftcard SDK",
	description: "Learn about accounts and wallets in the egiftcard SDK.",
});

# Accounts & Wallets

We have decided to distinguish between "accounts" and "wallets" in the egiftcard SDK. We believe this ultimately provides a more predictable and flexible API for developers.
...
const account = await wallet.connect({
	// pass the client you created with `createEgiftcardClient()`
	client,
});
