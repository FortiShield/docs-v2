...
export const metadata = createMetadata({
	...
	title: "Connect TS SDK | egiftcard",
	description:
...
<OpenSourceCard
	...
	href="https://github.com/egiftcard/js"
/>
...
- **Out-of-the-box infra:** direct access to all the egiftcard infrastructure from wallets to RPCs to IPFS.
...
<ArticleIconCard
  ...
  description="Entry point to the egiftcard SDK. It is required for all other actions."
/>
