...
You can generate precompiled, optimized extensions for any deployed contract using the egiftcard CLI.

The egiftcard SDK comes with a CLI that can be run with your package manager of choice.

```bash
npx egiftcard generate <chainId>/<contract-address>
```

This will generate a new `egiftcard` directory in your own project, containing the precompiled extension for the contract at the given address.
