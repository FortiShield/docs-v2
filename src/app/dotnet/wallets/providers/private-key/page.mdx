...
export const metadata = createMetadata({
	title: "PrivateKeyWallet.Create | Egiftcard .NET SDK",
	description:
...
Here is an example of creating a PrivateKeyWallet to sign a simple message. This example assumes you have a EgiftcardClient instance already created:

```csharp
var client = EgiftcardClient.Create("yourClientId");
