...
export const metadata = createMetadata({
	image: {
		title: "Supported Wallets in egiftcard React SDK",
		icon: "react",
	},
	title: "Supported Wallets | egiftcard React SDK",
	description: "List of all the supported wallets in egiftcard React SDK.",
});
...
egiftcard React SDK comes out of the box with support for below listed wallets:
