...
export const metadata = createMetadata({
	...
	title: "Web3Button | egiftcard React SDK",
...
2. The connected wallet is on the **correct network** which is specified in the `activeChain` prop of [EgiftcardProvider](/react/v4/EgiftcardProvider#activeChain) component. if wallet is connected to any other network, it renders a switch network button instead.
