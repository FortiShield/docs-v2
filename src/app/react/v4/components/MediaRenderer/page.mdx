...
Under the hood, the asset is fetched from IPFS through the egiftcard IPFS gateway (or just
...
You can use `npx egiftcard upload <path/to/file>` to upload any file to IPFS and get the IPFS URI.
