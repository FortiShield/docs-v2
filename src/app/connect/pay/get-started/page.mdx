...
export const metadata = createMetadata({
	image: {
		title: "egiftcard Pay - Get Started with Buy With Crypto",
		icon: "egiftcard",
	},
	title: "egiftcard Pay - Buy With Crypto | egiftcard",
	description:
		"Learn how to get a quote and send a transaction with the egiftcard SDK",
});
...
```bash
npm install egiftcard
```

### Create a client

A client is required to use egiftcard SDK. Refer to [this guide](/typescript/v5/client) to learn how to create a client.
