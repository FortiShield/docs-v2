...
export const metadata = createMetadata({
	image: {
		title: "Integrate egiftcard Auth with Firebase",
		icon: "wallets",
	},
	title: "Firebase | egiftcard",
	description:
...
<OpenSourceCard
	title="firebase-auth"
	href="https://github.com/egiftcard-example/firebase-auth"
	description="A working example of Auth + Firebase"
/>

```bash
npx egiftcard create app --template firebase-auth
```
...
From within the created directory, we need to install `@egiftcard/auth`, `firebase` and `firebase-admin`:

```bash npm2yarn
npm install @egiftcard/auth firebase firebase-admin
```
...
- [lib/initFirebase.ts](https://github.com/egiftcard-example/firebase-auth/blob/main/lib/initFirebase.ts)
- [lib/initFirebaseAdmin.ts](https://github.com/egiftcard-example/firebase-auth/blob/main/lib/initFirebaseAdmin.ts)
...
import { ConnectWallet, useAddress, useAuth } from "@egiftcard/react";
