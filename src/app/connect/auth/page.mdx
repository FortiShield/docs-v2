...
<OpenSourceCard
	title="Auth"
	href="https://github.com/egiftcard/js/tree/main/legacy_packages/auth"
/>

## Installation

<InstallTabs
	npm="npm i @egiftcard/auth"
	yarn="yarn add @egiftcard/auth"
	pnpm="pnpm i @egiftcard/auth"
/>
...
Auth integrates with a variety of server-side and client-side development frameworks. We&apos;re always adding support for more frameworks, so if you don&apos;t see yours, [let us know](https://egiftcard.cc/contact-us), and we can explore adding support!
