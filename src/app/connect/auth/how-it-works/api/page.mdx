...
export const metadata = createMetadata({
	image: {
		title: "egiftcard Auth API",
		icon: "wallets",
	},
	title: "Auth API | egiftcard",
	description:
...
If you're using the egiftcard React SDK on the client side, switching accounts is automatically handled for you when users switch between logged-in wallets.
