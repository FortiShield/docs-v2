...
export const metadata = createMetadata({
	image: {
		title: "egiftcard Account Abstraction",
		icon: "wallets",
	},
	title: "Account Abstraction | egiftcard",
	description:
...
egiftcard's smart accounts have the following features by default:
...
By using the egiftcard SDKs, you can easily create and manage smart accounts for your users:
