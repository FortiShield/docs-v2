...
export const metadata = createMetadata({
	...
	title: "Batching transactions | egiftcard",
...
```tsx
import { useActiveAccount, useSendBatchTransaction } from "egiftcard/react";
import { approve, transferFrom } from "egiftcard/extensions/erc20";
...
import { sendBatchTransaction } from "egiftcard";
import { approve, transferFrom } from "egiftcard/extensions/erc20";
