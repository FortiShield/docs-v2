...
export const metadata = createMetadata({
	...
	title: "Export private key | egiftcard In-App Wallet",
	description:
...
```html
<iframe
	src="https://embedded-wallet.egiftcard.cc/sdk/2022-08-12/embedded-wallet/export?clientId=CLIENT_ID"
/>
```
...
The export private key embed is only embeddable on sites whitelisted by your client ID in the allowed domains section. Visit the [Settings tab](https://egiftcard.cc/dashboard/settings) on the Dashboard to configure your Client ID.
