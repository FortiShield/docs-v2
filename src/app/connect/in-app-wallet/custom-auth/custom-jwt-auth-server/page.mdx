...
1. Navigate to Wallets > [In-App Wallets](https://egiftcard.cc/dashboard/wallets/embedded) in the egiftcard dashboard.
2. Create a egiftcard API key if you don't have one or select an existing key to use for this project. [Learn more about API keys.](/api-keys)
...
8. In your preferred egiftcard client SDK, pass the JWT you retrieved from logging in to the server.
