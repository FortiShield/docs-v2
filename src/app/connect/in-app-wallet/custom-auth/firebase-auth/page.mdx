...
1. Navigate to Wallets > [In-App Wallets](https://egiftcard.cc/dashboard/wallets/embedded)
...
After the connectInApp function returns, the EgiftcardProvider will have connected a wallet thereby granting access to all hooks and functionalities.
...
```jsx
import { useActiveAccount } from "egiftcard/react";
