...
export const metadata = createMetadata({
	...
	title: "Configure Authentication In-App Wallet | egiftcard",
	description:
...
- The `aud` value of the idToken: This is used to verify that egiftcard is the intended user of the token
