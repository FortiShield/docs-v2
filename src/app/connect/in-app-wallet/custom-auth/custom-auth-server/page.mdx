...
<Step title="Step 1">
	Navigate to Wallets > [In-App
	Wallets](https://egiftcard.cc/dashboard/wallets/embedded) in the egiftcard
	dashboard.
</Step>

<Step title="Step 2">
	Create a egiftcard API key if you don't have one or select an existing key to
...
<Step title="Step 5">
	...
	`https://embedded-wallet.egiftcard.cc/api/2023-11-30/embedded-wallet/auth/test-custom-auth-endpoint`
...
<Step title="Step 8">
	In your preferred egiftcard client SDK, pass the payload you retrieved from
...
The endpoint in step 3 is what you register as your auth endpoint on the egiftcard dashboard.
...
// This is a sample endpoint that you would register on the egiftcard dashboard for us to verify the payload
app.post("/egiftcard-will-call-this", (req, res) => {
