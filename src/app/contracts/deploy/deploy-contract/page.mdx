...
export const metadata = createMetadata({
	title: "Deploy Contract | egiftcard deploy",
	description: "deploy a contract using Deploy using egiftcard deploy CLI",
	image: {
...
Navigate to the root of the smart contract repository using the CLI. Then, run the command `npx egiftcard deploy`.
