...
export const metadata = createMetadata({
	...
	title: "Drop contract design document | egiftcard",
	description:
		"This is a live document that explains what the egiftcard Drop smart contracts are, how they work and can be used, and why they are written the way they are",
});
