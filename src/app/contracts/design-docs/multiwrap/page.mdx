...
export const metadata = createMetadata({
	...
	title: "Multiwrap design document | egiftcard",
	description:
		"This is a live document that explains what the egiftcard Multiwrap smart contract is, how it works and can be used, and why it is designed the way it is",
});
...
The document is written for technical and non-technical readers. To ask further questions about egiftcard's `Multiwrap` contract, please [visit our support site](https://egiftcard.cc/support) or create a github issue.
