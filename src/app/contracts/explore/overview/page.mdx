...
export const metadata = createMetadata({
	image: {
		title: "egiftcard Pre-built Contracts",
		icon: "contract",
	},
	title: "egiftcard Pre-built Contracts | Explore",
	description:
		"Pre-built contracts are proxy contracts created by the egiftcard team to cover most common use cases and patterns for smart contracts",
});

# Explore (Pre-built Contracts)

Pre-built contracts are proxy contracts created by the egiftcard team to cover most common use cases and patterns for smart contracts. Contracts cover various use cases across NFTs, airdrops, staking, marketplaces, memberships, and more. All pre-built contracts are available to deploy on [Explore](https://egiftcard.cc/explore).
