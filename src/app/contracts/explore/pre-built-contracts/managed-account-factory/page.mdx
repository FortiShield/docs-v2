...
export const metadata = createMetadata({
	...
	title: "Managed Account Factory | egiftcard",
...
The `ManagedAccount` smart wallet is an **upgradeable** smart contract written in the [dynamic contract pattern](https://github.com/egiftcard/dynamic-contracts).
...
egiftcard's smart wallets have the following features by default:
...
- [DynamicContract](https://github.com/egiftcard/dynamic-contracts)
