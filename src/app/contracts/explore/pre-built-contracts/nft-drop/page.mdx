...
export const metadata = createMetadata({
	...
	title: "NFT Drop contract | egiftcard",
...
<Step title="Select Contract">
	...
	Drop](https://egiftcard.cc/egiftcard.eth/DropERC721)
</Step>
...
Choose a Network / Chain to Deploy to. [View list of available Networks.](https://egiftcard.cc/chainlist)
...
1. In the CLI run the following Deploy command:
   ...
   ```bash
   npx egiftcard deploy -n --name nft-drop
   ```
...
```python
from egiftcard.types.settings.metadata import NFTDropContractMetadata
