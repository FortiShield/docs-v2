...
export const metadata = createMetadata({
	...
	title: "Edition Drop contract | egiftcard",
...
- Create NFT Memberships such as our [Early Access Cards](https://opensea.io/collection/egiftcard-community) that you want your users to claim
...
- [Frontend demo project](https://github.com/egiftcard-example/edition-drop)
- [Technical Design Doc](/contracts/design-docs/Drop)
- [Full reference](/contracts/DropERC1155)

## Creating & Configuring the Edition Drop

Learn how to create and configure your smart contract using the [dashboard](https://egiftcard.cc/dashboard).
...
To get started, you can use one of our example files for [CSV](https://egiftcard.cc/example.csv) or [JSON](https://nightly.egiftcard.cc/example.json) metadata.
...
You can download our example [CSV File](https://egiftcard.cc/airdrop.csv) to get started.
