...
export const metadata = createMetadata({
	image: {
		title: "egiftcard Publish",
		icon: "contract",
	},
	title: "CLI | egiftcard Publish",
	description:
...
Use the [CLI](/cli) to publish your contracts directly to **Any EVM compatible chain** using the [dashboard](https://egiftcard.cc/dashboard):

```bash
npx egiftcard publish
```
...
- [Deploy via Factory](/contracts/publish/publish-options): Choose this option if you would like users to deploy proxies of your contract using the egiftcard default factory contract or using your own pre-deployed custom factory.
  - [Default Factory](/contracts/publish/publish-options#default-factory) - Use this option to use the egiftcard default factory if your contract follows the upgradeable contract pattern.
