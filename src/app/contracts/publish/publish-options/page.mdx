...
export const metadata = createMetadata({
	...
	title: "Publish Options | egiftcard Publish",
	description:
...
Choose this option if you would like users to deploy proxies of your implementation contract using the egiftcard default factory contract or using your own pre-deployed custom factory.
...
Publishing your contract using the [egiftcard default factory](https://github.com/egiftcard/contracts/blob/main/contracts/infra/TWStatelessFactory.sol) allows users to deploy a proxy contract.
...
- The [egiftcard default factory](https://github.com/egiftcard/contracts/blob/main/contracts/infra/TWStatelessFactory.sol) is open-source, permissionless, and does not alter contract ownership - contract deployers have 100% ownership.
...
| [Deploy via Default Factory](/contracts/publish/publish-options#default-factory) | Users can deploy proxies of your implementation contract, containing the storage, using the egiftcard default factory | Protocols that want their contract to be deployable to all networks and want to gas-optimize the deploys                                | Must be written in the [upgradeable pattern](https://docs.openzeppelin.com/upgrades-plugins/1.x/writing-upgradeable). | Yes.                                                          | Yes.                                      |
