...
export const metadata = createMetadata({
	image: { title: "Get Started with egiftcard Solidity SDK", icon: "solidity" },
	title: "Get Started with egiftcard Solidity SDK",
	description:
...
import "@egiftcard/contracts/base/ERC721Base.sol";
import "@egiftcard/contracts/extension/Permissions.sol";
