...
export const metadata = createMetadata({
	...
	title: "ERC20Drop | egiftcard contracts",
	description:
...
```solidity
import "@egiftcard/contracts/base/ERC20Drop.sol";
```

<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/base/ERC20Drop.sol" />
