...
export const metadata = createMetadata({
	...
	title: "ERC20Vote | egiftcard contracts",
	description:
...
```solidity
import "@egiftcard/contracts/base/ERC20Vote.sol";
```

<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/base/ERC20Vote.sol" />
