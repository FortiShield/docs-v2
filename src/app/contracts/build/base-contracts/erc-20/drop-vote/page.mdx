...
export const metadata = createMetadata({
	...
	title: "ERC20DropVote | egiftcard contracts",
	description:
...
```solidity
import "@egiftcard/contracts/base/ERC20DropVote.sol";
```

<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/base/ERC20DropVote.sol" />
