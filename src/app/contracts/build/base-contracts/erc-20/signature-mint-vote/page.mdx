...
export const metadata = createMetadata({
	...
	title: "ERC20SignatureMintVote | egiftcard contracts",
	description:
...
```solidity
import "@egiftcard/contracts/base/ERC20SignatureMintVote.sol";
```

<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/base/ERC20SignatureMint.sol" />
