...
export const metadata = createMetadata({
	...
	title: "Account | egiftcard contracts",
	description:
...
```solidity
import "@egiftcard/contracts/smart-wallet/non-upgradeable/Account.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/prebuilts/account/non-upgradeable/Account.sol" />
...
```solidity
import "@egiftcard/contracts/smart-wallet/non-upgradable/Account.sol";
import "@egiftcard/contracts/eip/interface/IERC721.sol";
