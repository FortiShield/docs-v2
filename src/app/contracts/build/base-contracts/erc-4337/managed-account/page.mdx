...
export const metadata = createMetadata({
	...
	title: "Managed Account | egiftcard contracts",
	description:
...
```solidity
import "@egiftcard/contracts/smart-wallet/managed/ManagedAccount.sol";
```

This contract inherits from the [`BaseAccount`](/contracts/build/extensions/erc-4337/SmartWallet) contract.

The `ManagedAccount` is an _upgradeable_ smart account contract written in the [dynamic contract pattern](https://github.com/egiftcard/dynamic-contracts).
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/prebuilts/account/managed/ManagedAccount.sol" />
...
- Override the `_initializeAccount` function on the factory to create a new wallet. ([reference](https://github.com/egiftcard/contracts/blob/main/contracts/smart-wallet/non-upgradeable/AccountFactory.sol#L36))
