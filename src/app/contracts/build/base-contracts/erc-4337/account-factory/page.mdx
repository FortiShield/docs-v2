...
export const metadata = createMetadata({
	...
	title: "AccountFactory | egiftcard contracts",
	description:
...
```solidity
import "@egiftcard/contracts/smart-wallet/non-upgradeable/AccountFactory.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/prebuilts/account/non-upgradeable/AccountFactory.sol" />
