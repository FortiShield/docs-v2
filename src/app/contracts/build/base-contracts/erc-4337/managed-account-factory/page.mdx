...
export const metadata = createMetadata({
	...
	title: "Managed Account Factory | egiftcard contracts",
	description:
...
```solidity
import "@egiftcard/contracts/smart-wallet/managed/ManagedAccountFactory.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/prebuilts/account/managed/ManagedAccountFactory.sol" />
