...
All of egiftcard's [smart accounts](/connect/account-abstraction) are [EIP-4337](https://eips.ethereum.org/EIPS/eip-4337) smart contract accounts with role-based permission control.
...
The `ManagedAccount` smart account is an _upgradeable_ smart contract written in the [dynamic contract pattern](https://github.com/egiftcard/dynamic-contracts).
