...
export const metadata = createMetadata({
	...
	title: "ERC721SignatureMint | egiftcard contracts",
	description:
...
```solidity
import "@egiftcard/contracts/base/ERC721SignatureMint.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/base/ERC721SignatureMint.sol" />
