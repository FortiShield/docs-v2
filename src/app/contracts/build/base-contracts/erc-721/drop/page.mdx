...
export const metadata = createMetadata({
	...
	title: "ERC721Drop | egiftcard contracts",
	description:
...
```solidity
import "@egiftcard/contracts/base/ERC721Drop.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/base/ERC721Drop.sol" />
