...
export const metadata = createMetadata({
	...
	title: "ERC721DelayedReveal | egiftcard contracts",
	description:
...
```solidity
import "@egiftcard/contracts/base/ERC721DelayedReveal.sol";
```

<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/base/ERC721DelayedReveal.sol" />
