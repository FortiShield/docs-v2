...
export const metadata = createMetadata({
	title: "ERC1155Drop | egiftcard contracts",
	description:
...
```solidity
import "@egiftcard/contracts/base/ERC1155Drop.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/base/ERC1155Drop.sol" />
