...
export const metadata = createMetadata({
	title: "ERC1155LazyMint | egiftcard contracts",
	description:
...
```solidity
import "@egiftcard/contracts/base/ERC1155LazyMint.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/base/ERC1155LazyMint.sol" />
