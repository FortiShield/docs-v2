...
export const metadata = createMetadata({
	title: "ERC1155SignatureMint | egiftcard contracts",
	description:
...
```solidity
import "@egiftcard/contracts/base/ERC1155SignatureMint.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/base/ERC1155SignatureMint.sol" />
