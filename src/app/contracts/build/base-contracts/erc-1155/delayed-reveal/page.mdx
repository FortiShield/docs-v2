...
export const metadata = createMetadata({
	title: "ERC1155DelayedReveal | egiftcard contracts",
	description:
...
```solidity
import "@egiftcard/contracts/base/ERC1155DelayedReveal.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/base/ERC1155DelayedReveal.sol" />
