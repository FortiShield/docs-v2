...
export const metadata = createMetadata({
	...
	title: "PlatformFee | egiftcard contract",
	description:
...
```solidity
import "@egiftcard/contracts/extension/PlatformFee.sol";
```

`PlatformFee` allows you to charge a percentage fee wherever there is a transfer of currency (ERC20 tokens or native tokens) in your contract.

<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/extension/PlatformFee.sol" />
