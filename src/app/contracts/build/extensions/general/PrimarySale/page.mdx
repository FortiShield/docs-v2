...
export const metadata = createMetadata({
	...
	title: "PrimarySale | egiftcard contract",
	description:
...
```solidity
import "@egiftcard/contracts/extension/PrimarySale.sol";
```

`PrimarySale` lets you set a recipient for any sale value you intend to collect in your smart contract.

<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/extension/PrimarySale.sol" />
