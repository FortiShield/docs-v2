...
export const metadata = createMetadata({
	...
	title: "BatchMintMetadata | egiftcard contract",
	description:
...
```solidity
import "@egiftcard/contracts/extension/BatchMintMetadata.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/extension/BatchMintMetadata.sol" />
