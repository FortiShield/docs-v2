...
export const metadata = createMetadata({
	...
	title: "Ownable | egiftcard contract",
	description:
...
```solidity
import "@egiftcard/contracts/extension/Ownable.sol";
```

The `Ownable` smart contract extension is usable with any base smart contract. It lets you set an owner for your smart contract.

<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/extension/Ownable.sol" />
