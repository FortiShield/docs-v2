...
export const metadata = createMetadata({
	...
	title: "ContractMetadata | egiftcard contract",
	description:
...
```solidity
import "@egiftcard/contracts/extension/ContractMetadata.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/extension/ContractMetadata.sol" />
