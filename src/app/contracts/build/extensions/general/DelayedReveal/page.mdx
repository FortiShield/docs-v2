...
export const metadata = createMetadata({
	...
	title: "DelayedReveal | egiftcard contract",
	description:
...
```solidity
import "@egiftcard/contracts/extension/DelayedReveal.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/extension/DelayedReveal.sol" />
...
import "@egiftcard/contracts/base/ERC721LazyMint.sol";
import "@egiftcard/contracts/extension/DelayedReveal.sol";
...
- Learn more about the usage of this function in this [blogpost](https://blog.egiftcard.cc/delayed-reveal-nfts).
