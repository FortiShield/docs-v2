...
export const metadata = createMetadata({
	...
	title: "Royalty | egiftcard contract",
	description:
...
```solidity
import "@egiftcard/contracts/extension/Royalty.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/extension/Royalty.sol" />
