...
export const metadata = createMetadata({
	...
	title: "ERC1155Staking | egiftcard contract",
	description:
...
```solidity
import "@egiftcard/contracts/extension/Staking1155.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/extension/Staking1155.sol" />
