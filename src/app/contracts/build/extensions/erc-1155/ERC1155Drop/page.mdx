...
export const metadata = createMetadata({
	...
	title: "ERC1155Drop | egiftcard contract",
	description:
...
```solidity
import "@egiftcard/contracts/extension/Drop1155.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/extension/Drop1155.sol" />
