...
export const metadata = createMetadata({
	...
	title: "DropSinglePhase | egiftcard contract",
	description:
...
```solidity
import "@egiftcard/contracts/extension/DropSinglePhase1155.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/extension/DropSinglePhase1155.sol" />
