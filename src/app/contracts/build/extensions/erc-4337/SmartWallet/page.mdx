...
export const metadata = createMetadata({
	...
	title: "BaseAccount | egiftcard contract",
	description:
...
```solidity
import "@egiftcard/contracts/smart-wallet/utils/BaseAccount.sol";
```
...
<GithubButtonLink
	href="https://github.com/egiftcard/contracts/blob/main/contracts/prebuilts/account/utils/BaseAccount.sol"
	name="BaseAccount"
/>
...
import "@egiftcard/contracts/smart-wallet/utils/BaseAccountFactory.sol";
