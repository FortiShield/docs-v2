...
export const metadata = createMetadata({
	...
	title: "BaseAccountFactory | egiftcard contract",
	description:
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/prebuilts/account/utils/BaseAccountFactory.sol" />
