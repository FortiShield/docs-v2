...
export const metadata = createMetadata({
	...
	title: "AccountExtension | egiftcard contract",
	description:
...
```solidity
import "@egiftcard/contracts/smart-wallet/utils/AccountExtension.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/prebuilts/account/utils/AccountExtension.sol" />
