...
export const metadata = createMetadata({
	...
	title: "ERC20Mintable | egiftcard contract",
	description:
...
```solidity
import "@egiftcard/contracts/extension/interface/IMintableERC20.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/extension/interface/IMintableERC20.sol" />
