...
export const metadata = createMetadata({
	...
	title: "ERC20Staking | egiftcard contract",
	description:
...
```solidity
import "@egiftcard/contracts/extension/Staking20.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/extension/Staking20.sol" />
...
import "@egiftcard/contracts/eip/interface/IERC20Metadata.sol";
