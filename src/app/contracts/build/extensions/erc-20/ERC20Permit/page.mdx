...
export const metadata = createMetadata({
	...
	title: "ERC721Permit | egiftcard contract",
	description:
...
```solidity
import "@egiftcard/contracts/eip/interface/IERC20Permit.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/eip/interface/IERC20Permit.sol" />
