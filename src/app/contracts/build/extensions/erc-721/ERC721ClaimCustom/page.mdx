...
export const metadata = createMetadata({
	...
	title: "ERC721ClaimCustom | egiftcard contract",
	description:
...
import "@egiftcard/contracts/extension/interface/IClaimableERC721.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/extension/interface/IClaimableERC721.sol" />
