...
export const metadata = createMetadata({
	...
	title: "ERC721Staking | egiftcard contract",
	description:
...
```solidity
import "@egiftcard/contracts/extension/Staking721.sol";
```
...
<GithubButtonLink href="https://github.com/egiftcard/contracts/blob/main/contracts/extension/Staking721.sol" />
