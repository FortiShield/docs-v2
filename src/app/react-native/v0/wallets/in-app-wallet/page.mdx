...
export const metadata = createMetadata({
	...
	title: "In-App Wallet | egiftcard React Native SDK",
...
```tsx
import { inAppWallet } from "@egiftcard/react-native";
...
in your [Dashboard Settings](https://egiftcard.cc/dashboard/settings) and you will need to allowlist
...
```tsx
<EgiftcardProvider clientId="your-client-id" supportedWallets={[inAppWallet()]}>
	<YourApp />
</EgiftcardProvider>
```
...
[Android Google Play](https://play.google.com/store/search?q=egiftcard&c=apps&hl=en_US&gl=US)

[Apple App Store](https://apps.apple.com/us/app/egiftcard-connect/id6471451064)
