...
function Example() {
	return (
		<EgiftcardProvider activeChain={Gnosis} clientId="your-client-id">
			<App />
		</EgiftcardProvider>
	);
}
...
function App() {
	return (
		<EgiftcardProvider activeChain={<chain_id>} clientId="your-client-id">
			<YourApp />
		</EgiftcardProvider>
	);
}
...
const App = () => {
	return (
		<EgiftcardProvider activeChain={activeChain}>
			<YourApp />
		</EgiftcardProvider>
	);
};
...
const App = () => {
	return (
		<EgiftcardProvider activeChain={customChain}>
			<YourApp />
		</EgiftcardProvider>
	);
};
...
function MyApp() {
	return (
		<EgiftcardProvider activeChain="localhost">
			<YourApp />
		</EgiftcardProvider>
	);
}
