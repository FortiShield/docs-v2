...
export const metadata = createMetadata({
	image: {
		title: "Installing egiftcard React Native SDK",
		icon: "react",
	},
	title: "Installing egiftcard React Native SDK",
	description:
		"Steps to install the egiftcard React Native SDK in your existing or new project.",
});
...
<TabsContent value="cli_project">
	<InstallTabs
		npm="npm i ethers@^5 @egiftcard/react-native @egiftcard/react-native-compat node-libs-browser react-native-crypto react-native-randombytes react-native-get-random-values react-native-svg@^13.9.0 react-native-mmkv @react-native-async-storage/async-storage"
		yarn="yarn add ethers@^5 @egiftcard/react-native @egiftcard/react-native-compat node-libs-browser react-native-crypto react-native-randombytes react-native-get-random-values 'react-native-svg@^13.9.0' react-native-mmkv @react-native-async-storage/async-storage"
		pnpm="pnpm i ethers@^5 @egiftcard/react-native @egiftcard/react-native-compat node-libs-browser react-native-crypto react-native-randombytes react-native-get-random-values react-native-svg@^13.9.0 react-native-mmkv @react-native-async-storage/async-storage"
	/>
...
```javascript
// Import polyfills
import "@egiftcard/react-native-compat";
```
...
<TabsList>
	<TabsTrigger value="tw_cli">egiftcard CLI</TabsTrigger>
	<TabsTrigger value="tw_cli_expo">egiftcard CLI Expo</TabsTrigger>
...
```bash
npx egiftcard create --template react-native-typescript-starter
```
...
Note that running through <b>Expo Go</b> app currently isn't supported. You
    ...
    create an Expo React Native app using egiftcard CLI:

```bash
npx egiftcard create --template react-native-expo-starter
```
