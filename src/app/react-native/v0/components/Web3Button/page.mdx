...
export const metadata = createMetadata({
	...
	title: "Web3Button | egiftcard React Native SDK",
...
2. The connected wallet is on the **correct network**
   as specified in the `activeChain` prop of [EgiftcardProvider](/react-native/v0/EgiftcardProvider). if wallet is connected to any other network, it renders a switch network button instead.
