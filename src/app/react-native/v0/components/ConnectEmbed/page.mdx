...
You can start writing code with our [React Native Connect Embed template](https://github.com/egiftcard-example/react-native-connect-embed).
...
<GithubTemplateCard
	...
	href="https://github.com/egiftcard-example/react-native-connect-embed"
/>
