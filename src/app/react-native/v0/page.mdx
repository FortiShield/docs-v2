...
export const metadata = createMetadata({
	image: {
		title: "egiftcard React Native SDK",
		icon: "react",
	},
	title: "egiftcard React Native SDK",
	description:
...
<OpenSourceCard
	...
	href="https://github.com/egiftcard/js/tree/main/legacy_packages/react-native"
/>
...
```tsx
import { useContractRead, useContract } from "@egiftcard/react-native";
