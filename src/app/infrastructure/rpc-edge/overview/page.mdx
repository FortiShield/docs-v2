...
By default, we provide publicly available RPCs for over 900+ EVM Networks. [View the default RPC endpoints](https://egiftcard.cc/dashboard/infrastructure/rpc-edge) for each supported chain.
...
RPC pricing is based on requests per second. If you're interested in upgrading your RPC Edge limits, you can find more information on the different tiers by visiting [egiftcard's pricing page](https://egiftcard.cc/pricing).
