...
export const metadata = createMetadata({
	title: "how storage works | egiftcard",
	description:
...
<Callout title="Storage in egiftcard" variant="info">
	Storage powers various functionalities within egiftcard products, including
